...
CREATE TABLE `patient_measurements` (
  ...
  `date_retrieved` datetime DEFAULT NULL,
  `user_education_h-m-l` smallint unsigned DEFAULT NULL,
  `education_h-m-l` smallint unsigned DEFAULT NULL,
  ...
  `user_fear_level` smallint unsigned DEFAULT NULL,
  `fear_level` smallint unsigned DEFAULT NULL,
