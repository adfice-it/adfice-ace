...
UPDATE med_rules SET condition_problem = "depressie", condition_age = NULL, condition_drug = "&medication.startDate > now-6-months", condition_lab = "", condition_allergy = "" WHERE medication_criteria_id ="19";
UPDATE med_rules SET condition_problem = "depressie", condition_age = NULL, condition_drug = "&medication.startDate < now-6-months", condition_lab = "", condition_allergy = "" WHERE medication_criteria_id ="19a";
...
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "!natrium", condition_allergy = NULL WHERE medication_criteria_id ="23";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.natrium.date >= now-11-months", condition_allergy = "" WHERE medication_criteria_id ="24";
UPDATE med_rules SET condition_problem = "hyponatremia | orthostatische-hypotensie | tachycardia | arrhythmia", condition_age = NULL, condition_drug = NULL, condition_lab = " measurement.natrium.value < 135", condition_allergy = "allergic-reaction" WHERE medication_criteria_id ="25";
...
UPDATE med_rules SET condition_problem = "hypokalemia", condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.kalium.value < 3.0", condition_allergy = NULL WHERE medication_criteria_id ="40";
UPDATE med_rules SET condition_problem = "hyponatremia", condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.natrium.value < 130", condition_allergy = NULL WHERE medication_criteria_id ="40a";
UPDATE med_rules SET condition_problem = "hypercalciemie", condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.calcium.value > 2.65", condition_allergy = NULL WHERE medication_criteria_id ="40b";
...
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.value > 30 &measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="68";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.value <= 30 &measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="69";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "!measurement.eGFR", condition_allergy = NULL WHERE medication_criteria_id ="70";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="71";
...
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.value > 30", condition_allergy = NULL WHERE medication_criteria_id ="79";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.value <= 30 &measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="80";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "!measurement.eGFR.value <= 30 &measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="80a";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "! measurement.eGFR.value <= 30", condition_allergy = NULL WHERE medication_criteria_id ="80b";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "! measurement.eGFR", condition_allergy = NULL WHERE medication_criteria_id ="81";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="82";
...
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.value > 30 &measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="89";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.value <= 30 &measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="90";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "!measurement.eGFR", condition_allergy = NULL WHERE medication_criteria_id ="91";
UPDATE med_rules SET condition_problem = NULL, condition_age = NULL, condition_drug = NULL, condition_lab = "measurement.eGFR.date > now-11-months", condition_allergy = NULL WHERE medication_criteria_id ="92";
