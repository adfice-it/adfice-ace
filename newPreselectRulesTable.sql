...
("6e",2,2,NULL,NULL,"parkinson | lewy-bodies-dementia | multiple-system-atrophy | progressive-supranuclear-palsy",NULL,NULL,NULL,NULL),
...
("42",2,1,"C03CA,C03CB,C03EB",NULL,"!hartfalen",NULL,NULL,NULL,NULL),
("42",2,2,NULL,NULL,"!hypertensie &!hartfalen",NULL,NULL,NULL,NULL),
("42",2,3,"C03CA,C03CB,C03EB",NULL,"jicht | hypokalemia | hyponatremia | hypercalciemie",NULL,NULL,"measurement.natrium.value < 130 | measurement.kalium.value < 3.0 | measurement.calcium.value  > 2.65",NULL),
("42",2,4,NULL,NULL,"parkinson",NULL,NULL,NULL,NULL),
("42",2,5,NULL,NULL,"(parkinson | lewy-bodies-dementia | multiple-system-atrophy | progressive-supranuclear-palsy) & orthostatische-hypotensie",NULL,NULL,NULL,NULL),
("42",2,6,"C07DA",NULL,NULL,NULL,NULL,NULL,NULL),
