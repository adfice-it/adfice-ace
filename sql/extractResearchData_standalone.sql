...
WHERE patient.participant_number is not null and patient.participant_number in (select participant_number from research_map) and patient.row_updated >= @lookback;
