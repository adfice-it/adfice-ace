...
* a combination of the above (right now they are only combined with &, although an | is possible)
...
A patient can have any number of lab values. It is probably a good idea to pass this is as key-values:
key: test_name
value:
	key: test_result
	key: date_measured
